...
pub struct MigrateContext<'t, 'c> {
    pub query_builder: &'static dyn sea_query::SchemaBuilder,
...
async fn migrate_from_empty_to_0(ctx: &mut MigrateContext<'_, '_>) -> Result<()> {
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .col(sea_query::ColumnDef::new(Types::BackingTable).text().unique_key())
            .col(sea_query::ColumnDef::new(Types::ApiVersion).text().unique_key()),
    ).await?;
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .col(sea_query::ColumnDef::new(TypeNames::Name).text().unique_key())
            .foreign_key(
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .col(sea_query::ColumnDef::new(FieldNames::FieldName).text().unique_key())
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .if_not_exists()
            .col(sea_query::ColumnDef::new(Endpoints::Path).text().unique_key())
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .if_not_exists()
            .col(sea_query::ColumnDef::new(Sessions::Token).uuid().primary_key())
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .col(sea_query::ColumnDef::new(Policies::Version).text().unique_key())
...
async fn migrate_from_0_to_0_7(ctx: &mut MigrateContext<'_, '_>) -> Result<()> {
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .col(sea_query::ColumnDef::new(ChiselVersion::VersionId).text().unique_key())
...
async fn migrate_from_0_7_to_0_12(ctx: &mut MigrateContext<'_, '_>) -> Result<()> {
    ...
    execute_stmt(
        ...
        sea_query::Table::create()
            .table(ApiInfo::Table)
            .if_not_exists()
            .col(sea_query::ColumnDef::new(ApiInfo::ApiVersion).text().unique_key())
    ...
    let _: Result<_> = execute_stmt(
        ...
        sea_query::Table::rename()
            .table(Endpoints::Table, Sources::Table),
    ).await;
...
async fn migrate_from_0_12_to_0_13(ctx: &mut MigrateContext<'_, '_>) -> Result<()> {
    execute_stmt(
        ...
        sea_query::Table::create()
            ...
            .primary_key(sea_query::Index::create().col(Modules::Version).col(Modules::Url)),
    ).await?;
...
async fn execute_stmt<S>(ctx: &mut MigrateContext<'_, '_>, stmt: &S) -> Result<()>
    where S: sea_query::SchemaStatementBuilder
{
    let sql = stmt.build_any(ctx.query_builder);
